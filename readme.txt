...
3. Import events: Events > Import & Tools > upload your CSV, review the preview, then Run Import.
   - Reimporting a corrected sheet is safe: rows matching an existing event (name + date) update it, including filling times on TBD events.
...
The full calendar feed lives at:
  https://yoursite.com/?ash_ical=1
Single events offer Google / Apple / Outlook subscribe links and an .ics download on the event page.
